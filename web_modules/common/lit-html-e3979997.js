 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;class L{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new T(t,e.slice(1),s).parts}return"@"===i?[new C(t,e.slice(1),n.eventContext)]:"?"===i?[new E(t,e.slice(1),s)]:new V(t,e,s).parts}handleTextExpression(t){return new b(t)}}const $=new L;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const I=(t,...e)=>new f(t,e,"html",$),F=(t,...e)=>new x(t,e,"svg",$);export{V as A,E as B,L as D,C as E,b as N,T as P,x as S,g as T,e as a,i as b,r as c,$ as d,w as e,y as f,N as g,I as h,s as i,A as j,B as k,k as l,f as m,a as n,m as o,P as p,p as q,o as r,F as s,H as t,d as u,l as v};
//# sourceMappingURL=lit-html-e3979997.js.map
