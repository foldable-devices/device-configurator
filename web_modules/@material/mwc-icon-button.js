import{b as t}from"../common/ponyfill-792d38b8.js";import{h as o}from"../common/lit-html-9957b87e.js";import{property as i,LitElement as n,css as e,customElement as c}from"../lit-element.js";import"../common/events-a64aa528.js";import{a as r}from"../common/ripple-directive-cbcd40f6.js";class a extends n{constructor(){super(...arguments),this.disabled=!1,this.icon="",this.label=""}render(){return o`<button
    .ripple="${r()}"
    ...
    <slot></slot>
  </button>`}}t([i({type:Boolean,reflect:!0})],a.prototype,"disabled",void 0),t([i({type:String})],a.prototype,"icon",void 0),t([i({type:String})],a.prototype,"label",void 0);
/**
@license
...
See the License for the specific language governing permissions and
limitations under the License.
*/;let p=class extends a{};p.styles=d,p=t([c("mwc-icon-button")],p);export{p as IconButton};
